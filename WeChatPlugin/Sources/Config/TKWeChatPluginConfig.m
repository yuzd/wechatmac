...
static NSString * const kTKSyncUrlKey = @"kTKSyncUrlKey";
static NSString * const kTKEnableSyncUrlKey = @"kTKEnableSyncUrlKey";
...
@property (nonatomic, copy) NSString *groupPlistFilePathTemp;
@property (nonatomic, copy) NSString *userPlistFilePathTemp;
...
- (instancetype)init {
    ...
    if (self) {
        ...
        _syncUrlEnable = [[NSUserDefaults standardUserDefaults] boolForKey:kTKEnableSyncUrlKey];
        _syncUrl = [[NSUserDefaults standardUserDefaults] stringForKey:kTKSyncUrlKey];
    }
    return self;
}
...
- (void)setSyncUrlEnable:(BOOL)syncUrlEnable {
    _syncUrlEnable = syncUrlEnable;
    [[NSUserDefaults standardUserDefaults] setBool:syncUrlEnable forKey:kTKEnableSyncUrlKey];
    [[NSUserDefaults standardUserDefaults] synchronize];
}
...
- (void)setSyncUrl:(NSString *)url {
    _syncUrl = url;
    [[NSUserDefaults standardUserDefaults] setObject:url forKey:kTKSyncUrlKey];
    [[NSUserDefaults standardUserDefaults] synchronize];
}
...
- (NSString *)groupPlistFilePath {
    if (!_groupPlistFilePathTemp) {
        _groupPlistFilePathTemp = [self getSandboxFilePathWithPlistName:@"group.plist"];
    }
    return _groupPlistFilePathTemp;
}

- (NSString *)userPlistFilePath {
    if (!_userPlistFilePathTemp) {
        _userPlistFilePathTemp = [self getSandboxFilePathWithPlistName:@"user.plist"];
    }
    return _userPlistFilePathTemp;
}
